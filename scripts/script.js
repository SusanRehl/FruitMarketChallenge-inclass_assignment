...
var appleInventory = function(){
	...
	document.getElementById('budgetToSpend').innerHTML = totalCash;
};
$(document).ready(function() {
...
setInterval(function() {
	...
	// console.log(random);
	var newFruitPrice = (fruitPrices[i] + random).toLocaleString("en-US", {style: "currency", currency: "USD", minimumFractionDigits: 0});
